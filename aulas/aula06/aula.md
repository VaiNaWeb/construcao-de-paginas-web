...
Para adicionar vídeo usamos o elemento <video>. Todos os mesmos atributos (src, reprodução automática, controles, loop) que funcionam no áudio funcionam no vídeo também.
